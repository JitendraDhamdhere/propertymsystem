...
<body>
	...
	<section class="container my-5 pt-5">
		<div class="row">
			<%
			try {
				String sql = "SELECT title, type, price, location, size, bedrooms, bathrooms, status, image FROM properties";
			...
			<div class="col-lg-4 col-md-6 col-sm-12 mb-4">
				<div class="card property-card">
					<%
					// Check if the image URL is null or empty, and set a default image if needed
