...
<body>
	...
	<div class="container mt-5 pt-5">
		<h2 class="text-center mb-4" style="padding-top: 50px;">Exciting
			Packages Just for You!</h2>
		<div class="row">
			<!-- Package 1 -->
			<div class="col-md-4">
				<div class="card">
					<img src="image/CarnivalRide.jpg" class="card-img-top"
						alt="Family Fun Pack">
					<div class="card-body">
						<h5 class="card-title">Family Fun Pack</h5>
						<p class="card-text">Unlimited rides and attractions for the
							whole family! Enjoy thrilling experiences and memorable moments.</p>
			...
			<div class="col-md-4">
				<div class="card">
					<img src="image/ttower.jpg" class="card-img-top"
						alt="Adventure Seeker">
					<div class="card-body">
						<h5 class="card-title">Adventure Seeker</h5>
						<p class="card-text">Perfect for adrenaline junkies! Access to
							all thrill rides and adventure zones.</p>
			...
			<div class="col-md-4">
				<div class="card">
					<img src="image/BalloonRace.jpg" class="card-img-top"
						alt="Kids Special">
					<div class="card-body">
						<h5 class="card-title">Kids Special</h5>
						<p class="card-text">A special package designed for kids with
							fun rides and playful activities.</p>
