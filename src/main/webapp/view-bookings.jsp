...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
		<div class="container-fluid">
			<a class="navbar-brand" href="admin-dashboard.jsp"> <img
				src="image/LOGO.jpg" alt="Property Management System Logo"
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item"><a class="nav-link"
						href="view-bookings.jsp">View Bookings</a></li>
					<li class="nav-item">
						<form method="post" class="d-inline">
							<button type="submit" name="logout"
								class="btn btn-danger text-white nav-link">Logout</button>
						</form>
					</li>
				</ul>
			</div>
	...
	<div class="container mt-5 pt-5">
		<div class="card">
			...
			<div class="card-body">
				<!-- Back Button -->
				<a href="admin-dashboard.jsp" class="btn btn-primary back-btn">Back
					to Dashboard</a>
